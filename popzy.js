...
function Popzy(options = {}) {
     ...
     const closeMethods = this.opt.closeMethods;
     ...
     this._handleEscap = this._handleEscap.bind(this);
...
Popzy.prototype.build = function () {
     ...
     if (this._allowButtonClose) {
          const closeBtn = this._creatButton(
               "&times;",
               "popzy__close",
               () => this.close()
          );
...
Popzy.prototype.addFooterButton = function (title, cssClass, callback) {
     const button = this._creatButton(title, cssClass, callback)
...
Popzy.prototype._renderFooterBotton = function () {
...
Popzy.prototype._creatButton = function (title, cssClass, callback) {
...
Popzy.prototype.open = function () {
     ...
     if (this._allowEscapeClose) {
          document.addEventListener("keydown", this._handleEscap)
     }
...
Popzy.prototype._handleEscap = function (e) {
...
Popzy.prototype.close = function (destroy = this.opt.destroyOnClose) {
     ...
     this._ontransitionend(() => {
          if (this._backdrop && destroy) {
               ...
               document.removeEventListener("keydown", this._handleEscap)
          }
